    ...
    <form onSubmit={handleSubmit}>
      <div className='flex flex-grow flex-col gap-5'>
        <div className='flex flex-col gap-5 md:flex-row'>
          <input
            className='w-full rounded-md border border-zinc-300 bg-gradient-to-br from-zinc-50 to-zinc-100 px-3 py-2 text-zinc-800 focus:outline-none dark:border-zinc-700 dark:from-zinc-900 dark:to-zinc-950/90 dark:text-zinc-200'
            type='text'
            placeholder='Name*'
            name='name'
            value={formData.name}
        ...
        <Button
          className={clsx(
            'flex justify-center !bg-zinc-200 py-2.5 hover:!bg-zinc-300 dark:!border-zinc-700 dark:!bg-zinc-800 dark:hover:!bg-zinc-700',
          )}
          type='submit'
          icon={<></>}
