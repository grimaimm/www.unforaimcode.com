...
const OverviewItem = ({ label, value, unit = '' }) => (
  <Card className='flex flex-col self-center rounded-xl border border-zinc-200 bg-gradient-to-br from-white to-zinc-100 px-4 py-3 dark:border-zinc-700 dark:from-zinc-800 dark:to-zinc-900/50'>
