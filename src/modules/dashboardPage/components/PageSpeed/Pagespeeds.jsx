...
//   const activePage = data?.find(
//     (page) => page.id.toLowerCase() === activeTab.toLowerCase(),
//   ) || { contents: {} };
...
//       />
//       <SectionSubHeading>
//         <p className='dark:text-zinc-400'>My pagespeed index by google APIs</p>
//         <Link
//           href=''
//           target='_blank'
//           passHref
//           className='hidden text-sm text-zinc-600 dark:text-zinc-500 sm:block'
//         >
//           PageSpeed
//         </Link>
//       </SectionSubHeading>
