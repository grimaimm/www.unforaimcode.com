import { formatDateV1 } from "@/common/helpers/formatDate"
...
const Overview = ({ data }) => {
  ...
  const startDate = data?.start_date ? formatDateV1(data.start_date) : ""
  const endDate = data?.end_date ? formatDateV1(data.end_date) : ""
  const bestDay = bestDayDate
    ? `${formatDateV1(bestDayDate)} (${bestDayText})`
    : "N/A"
