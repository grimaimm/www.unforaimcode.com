      ...
      components={{
        ...
        blockquote: ({ node, ...props }) => {
          ...
          return (
            <blockquote
              id={id}
              className='rounded-br-2xl border-l-[5px] border-zinc-700 border-l-indigo-500 bg-zinc-200 py-3 pl-6 text-lg font-semibold text-indigo-800 dark:bg-zinc-800 dark:text-indigo-300'
              {...props}
            />
          );
        },
