  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ node, ...props }) => (
          <h2
            className="text-xl font-medium dark:text-zinc-300"
            {...props}
          />
        ),
        ...
        code: ({ node, inline, className, children, ...props }) => {
          ...
          return !inline && match ? (
            ...
            <code className="rounded-md bg-zinc-200 px-2 py-1 text-[14px] font-light text-sky-600 dark:bg-zinc-700 dark:text-sky-300" {...props}>
              {children}
            </code>
          );
        },
        ...
        blockquote: ({ node, ...props }) => {
          ...
          return (
            <blockquote
              id={id}
              className="rounded-br-2xl font-semibold border-l-[5px] border-zinc-700 border-l-indigo-500 bg-zinc-200 py-3 pl-6  text-lg text-indigo-800 dark:bg-zinc-800 dark:text-indigo-300"
              {...props}
            />
          );
        },
        ...
        th: ({ node, ...props }) => (
          <th className="border px-3 py-1 text-left dark:border-zinc-600" {...props} />
        ),
