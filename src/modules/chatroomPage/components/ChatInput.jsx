      ...
      <form className='flex items-end gap-x-1 border-t border-zinc-300 py-4 pb-3 dark:border-zinc-800'>
        <div className='flex w-full flex-col space-y-2'>
          ...
          <input
            ...
            placeholder={
              replyTo ? `Replying to @${replyTo}...` : 'Type a message...'
            }
            className='flex-grow rounded-md border border-zinc-300 bg-gradient-to-br from-zinc-50 to-zinc-100 p-2 text-zinc-800 focus:outline-none dark:border-zinc-700 dark:from-zinc-900 dark:to-zinc-950/90 dark:text-zinc-200'
            disabled={isSending}
            ref={inputRef}
            autoFocus
          />
