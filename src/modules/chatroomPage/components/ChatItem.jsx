  ...
  return (
    ...
    >
      ...
      <div className='flex w-full flex-col space-y-1'>
        ...
        >
          <div className='w-auto max-w-[90%] rounded-xl rounded-tl-none bg-zinc-200 px-3 py-2 font-sans dark:bg-zinc-800'>
            <p className='text-zinc-700 dark:text-zinc-200'>
              {is_reply && (
                <>
                  <span className='mr-1 whitespace-nowrap text-indigo-600 dark:text-indigo-400'>
                    @{reply_to}
                  </span>
                  <span>{message}</span>
                </>
