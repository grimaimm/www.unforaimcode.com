  ...
  return (
    <section className='space-y-2 bg-cover bg-no-repeat'>
      <div className='flex items-center justify-between'>
        <div
          className='flex gap-2 text-2xl font-medium text-zinc-800 dark:text-zinc-300 lg:text-3xl'
          aria-live='polite'
        >
          <TypeAnimation
            sequence={[
      ...
      <div className='space-y-4'>
        ...
        <p className='leading-[1.8] text-zinc-800 dark:text-zinc-300 md:leading-loose'>
          Experienced Web Developer skilled in ReactJS, TailwindCSS, JavaScript,
          and proficient in Flask and Python. Collaborative team player
          dedicated to delivering efficient, scalable, and visually appealing
          web applications.
        </p>
      </div>
    </section>
