...
import { SiCss3, SiExpress, SiFirebase, SiGithub, SiHtml5, SiJavascript, SiNextdotjs, SiNodedotjs, SiReact, SiSass, SiTailwindcss, SiJupyter, SiPwa, SiFastapi, SiFlask, SiSocketdotio } from 'react-icons/si';
import { FaRobot } from 'react-icons/fa';
import { PythonIcon, SQLiteIcon, MySQLIcon } from '@/common/components/elements/Icons';

const iconSize = '100%';

export const STACKS = {
  'Artificial Intelligence': <FaRobot size={iconSize} className="text-pink-500" />,
  ...
  SocketIo: <SiSocketdotio size={iconSize} className="text-black dark:text-white" />,
