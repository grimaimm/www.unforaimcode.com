...
import { TbTextWrapDisabled as NoWrap, TbTextWrap as Wrap } from "react-icons/tb";
    ...
    <div className="group relative">
      ...
      >
        <button
          ...
          className={clsx([
            'md:hidden',
            'rounded-md md:p-1.5 p-1 text-lg transition-colors md:block',
            'border border-gray-300 dark:border-neutral-900 dark:hover:border-neutral-800',
            'text-neutral-700 dark:text-neutral-400',
            'bg-[#ffffff] hover:bg-gray-100 dark:bg-charcoal-500 dark:hover:bg-charcoal-400',
          ])}
        >
          {/* <BsTextWrap /> */}
          {!isWrapped ? (
