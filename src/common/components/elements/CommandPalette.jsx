...
const CommandPalette = () => {
  ...
  const placeholders = ['Search or Ask anything...'];
  ...
  const isEmptyState = filteredMenuOptions.every(
    ...
    <Transition.Root show={isOpen} as={React.Fragment}>
      ...
      >
        ...
        <Dialog.Panel>
          ...
          >
            <div className='shadow-3xl relative mx-auto max-w-xl overflow-hidden rounded-xl border-2 border-zinc-100 bg-white ring-1 ring-black/5 backdrop-blur dark:divide-zinc-600 dark:border-zinc-800 dark:bg-[#1b1b1b80]'>
