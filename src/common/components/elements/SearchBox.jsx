...
const SearchBox = () => {
  ...
  return (
    <div className="flex mb-3 items-center max-lg:mx-0 mx-4 gap-3 rounded-lg border-[1.8px] border-zinc-300 bg-zinc-100 px-3 py-1 text-zinc-500 backdrop-blur dark:border-zinc-700 dark:bg-zinc-900">
      <FiSearch size={28} />
      <span
